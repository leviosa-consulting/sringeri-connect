  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative w-full overflow-x-hidden">
      ...
      <main className={cn(
        ...
        isDesktop ? "max-w-7xl px-6 py-8" : "max-w-lg pb-28"
      )}>
        {children}
      </main>

      {/* Mobile Social Bar + Bottom Navigation */}
      {!isDesktop && (
        <>
          <div className="fixed bottom-16 w-full bg-[#fcfbf7] border-t border-border/50 z-40">
            <div className="flex justify-center items-center gap-4 py-2 max-w-md mx-auto">
